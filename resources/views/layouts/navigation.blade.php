    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <x-nav-link :href="route('schedule.personal')" :active="request()->routeIs('schedule.personal')">
                    {{ __('Мой график') }}
                </x-nav-link>

                <!-- Пожелания -->
                <x-nav-link :href="route('preferences.calendar')" :active="request()->routeIs('preferences.calendar')">
                    {{ __('Мои пожелания') }}
                </x-nav-link>
